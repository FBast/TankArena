...
namespace Plugins.ReflexityAI.Framework {
    ...
    public class ReflexityAI : MonoBehaviour {
        ...
        [Tooltip("If checked the brains will be initialized on Start")]
        public bool InitBrainOnStart = true;
        ...
        private void Start() {
            if(!InitBrainOnStart || AIBrains.Count == 0) return;
            InitBrains();
        }
        ...
        /// <summary>
        /// Use this method to manually launch the local brain copy
        /// </summary>
